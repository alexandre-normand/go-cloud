...
import (
	...
	_ "github.com/alexandre-normand/go-cloud/mysql/azuremysql"
)

func Example() {
	// PRAGMA: This example is used on gocloud.dev; PRAGMA comments adjust how it is shown and can be ignored.
	// PRAGMA: On gocloud.dev, add a blank import: _ "github.com/alexandre-normand/go-cloud/mysql/azuremysql"
